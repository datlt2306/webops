...
const footerLinks: FooterSection[] = [
    {
        label: "Dịch vụ",
        links: [
            { title: "Thiết kế website", href: "#services" },
            { title: "SEO & Content", href: "#services" },
            { title: "Tool & tự động hóa", href: "#services" },
            { title: "Vận hành & bảo trì", href: "#services" },
        ],
    },
    {
        label: "Công ty",
    ...
    },
    {
        ...
        links: [
            ...
            { title: "Case Study", href: "#projects" },
            { title: "FAQ", href: "/faq" },
