            ...
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 text-balance">
                        Tùy chỉnh theo mục tiêu của bạn
                    </h2>
                    <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto text-balance">
                        Chúng tôi đề xuất gói phù hợp hoặc thiết kế giải pháp riêng theo yêu cầu của
                        bạn.
                    </p>
                </div>
                ...
                >
                    <p className="text-sm text-blue-100/80">
                        Giá đã bao gồm thiết kế, phát triển, tối ưu cơ bản và hướng dẫn quản trị.
                        Phạm vi mở rộng sẽ được báo giá rõ ràng sau buổi tư vấn.
                    </p>
                </div>
            </div>
        </section>
