      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mt-4">Chia sẻ từ đội ngũ</h2>
            <p className="text-blue-100 mt-2">Cập nhật insight SEO, UI/UX và tự động hóa mới nhất.</p>
          </div>
          <a
            href="/blog"
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {articles.map((article) => (
            ...
            >
              <span className="text-xs font-semibold px-3 py-1 rounded-full bg-white/10 text-blue-100">{article.tag}</span>
              <h3 className="text-xl text-white font-semibold mt-4">{article.title}</h3>
